...
class _LocationWiseCollectionState extends State<LocationWiseCollection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: Lab_Total_Business_only_Widget,
      ...
      Padding(
        ...
        child: Card(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: BorderSide(color: Color.fromARGB(255, 156, 208, 251)
              ...
              child: Column(children: [
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.location_pin,
                              size: 22, color: Color.fromARGB(255, 36, 73, 151)
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(data.GROSS.toString(),
                                    style: TextStyle(
                                        color: Colors.black,
                ...
                IntrinsicHeight(
                  child: Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.fromLTRB(62, 0, 62, 0),
                          child: Column(
                            // crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Orders'),
                      ...
                      Row(
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              for (var i in data.SERVICE_GROUP_NAME.split(','))
                                Container(
                                    height: 40,
                                    width: 180,
                                    child: InkWell(
                            ...
                            children: [
                              for (var i in data.TOTAL_CNTS.split(','))
                                Container(
                                  ...
                                  child: CircleAvatar(
                                    backgroundColor:
                                        Color.fromARGB(255, 196, 215, 233),
                                    radius: 12.0,
                                    child: ClipRRect(
                                      child: Text(
                                        i.toString(),
                          ...
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              for (var i in data.SERVICE_GROUP_ID.split(','))
                                Container(
                                    height: 40,
                                    width: 40,
                                    child: InkWell(
