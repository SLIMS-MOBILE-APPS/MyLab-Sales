                        ...
                        children: [
                          ...
                          (data.SERVICE_GROUP_ID != "null" &&
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    for (var i
                                        in data.SERVICE_GROUP_CNT.split(','))
                                      Container(
                                        height: 40,
                                        child: CircleAvatar(
                        ...
                        children: [
                          (data.CARDIALOGY_NAMES != "null" &&
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    for (var i
                                        in data.CARDIALOGY_NAMES.split(','))
                                      Container(
                                          height: 45,
                                          width: 180,
                                          child: InkWell(
                          ...
                          (data.CARDIALOGY_COUNTS != "null" &&
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    for (var i
                                        in data.CARDIALOGY_COUNTS.split(','))
                                      Container(
                                        height: 45,
                                        child: CircleAvatar(
                                          backgroundColor: Color.fromARGB(
