...
class SERVICE_WISE_PATIENTS_REPORT extends StatefulWidget {
  int index;

  int selectedIndex;
  SERVICE_WISE_PATIENTS_REPORT(this.index, this.selectedIndex);
  @override
  State<SERVICE_WISE_PATIENTS_REPORT> createState() =>
      _SERVICE_WISE_PATIENTS_REPORTState(this.index, this.selectedIndex);
}

class _SERVICE_WISE_PATIENTS_REPORTState
    extends State<SERVICE_WISE_PATIENTS_REPORT> {
