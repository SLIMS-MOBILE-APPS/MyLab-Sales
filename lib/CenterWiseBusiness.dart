        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: <Widget>[
              ...
              Tab(icon: Icon(Icons.water_drop_outlined), text: 'By Test'),
        ...
        child: Card(
            ...
            child: Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Icon(Icons.location_history, color: Colors.red),
                  Padding(
                  ...
                  Spacer(),
                  Text(data.CLIENT_AMOUNT.toString(),
                      style: TextStyle(
                          color: Colors.indigo,
                          fontWeight: FontWeight.bold,
                          fontSize: 12.0)),
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.business_outlined,
                          color: Color.fromARGB(255, 32, 69, 172)),
                      Padding(
                        padding: const EdgeInsets.only(left: 8.0),
                      ...
                      Spacer(),
                      Text(data.CHANNEL_AMOUNT.toString(),
                          style: TextStyle(
                              color: Colors.indigo,
                              fontWeight: FontWeight.bold,
                              fontSize: 12.0)),
              ...
              child: Row(
                ...
                children: [
                  Transform.rotate(
                      ...
                      child: Icon(
                        Icons.filter_alt_outlined,
                        color: Color.fromARGB(255, 47, 57, 161),
                      )),
                  Padding(
                    padding: const EdgeInsets.only(left: 8.0),
                  ...
                  Spacer(),
                  Text(data.DEPT_AMOUNT.toString(),
                      style: TextStyle(
                          color: Colors.indigo,
                          fontWeight: FontWeight.bold,
                          fontSize: 12.0)),
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Spacer(),
                Text(data.TEST_AMOUNT.toString(),
                    style: TextStyle(
                        color: Colors.indigo,
                        fontWeight: FontWeight.bold,
                        fontSize: 12.0)),
